...
public class EmailValidator {
	 public static void main( String args[] ) {
		 List<String> testEmails = TextReader.read("G:\\eclipse\\email-validator\\src\\com\\mouravocal\\emails.txt");
		
	      for ( int ctr = 0 ; ctr < testEmails.size() ; ctr++ ) {
	         System.out.println( testEmails.get(ctr) + " is valid? " + 
	               isAddressValid( testEmails.get(ctr) ) );
	      }
	      System.out.println("All emails tested!!");
	      return;
	      }
